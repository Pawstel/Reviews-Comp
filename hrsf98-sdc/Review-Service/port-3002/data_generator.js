...
const insertReviews = () => {
  ...
  while (reviewUser < 10) {
    for (let i = 1; i <= 1000000; i++) {
        ...
        reviewString += `${reviewId}, ${reviewId}, ${Math.floor(Math.random() * Math.random() * 3000000 + 1)}, ${review.accuracy}, ${review.communication}, ${review.cleanliness}, ${review.location}, ${review.check_in}, ${review._value}, ${review.date}, ${review._content} \n`
        reviewId++;
    }
  ...
  while (reviewCalled < 30) {
    for (let i = 1; i <= 1000000; i++) {
        let review = getReview();
        reviewString += `${reviewId}, ${Math.floor(Math.random() * Math.random() * 10000000) + 1}, ${Math.floor(Math.random() * Math.random() * 3000000 + 1)}, ${review.accuracy}, ${review.communication}, ${review.cleanliness}, ${review.location}, ${review.check_in}, ${review._value}, ${review.date}, ${review._content} \n`
        reviewId++;
    }
